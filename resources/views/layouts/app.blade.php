                    ...
                    @if (!Auth::guest())
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                @can('list sensor')
                                    <a class="dropdown-item" href="{{url('/sensors')}}">{{__('menu.my_sensors')}}</a>
                                @endcan
                                @can('create sensor')
                                    <a class="dropdown-item" href="{{url('/sensor/add')}}">{{__('menu.add_sensor')}}</a>
                                @endcan
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{url('/scenarios')}}">Scénarios</a>
                                <a class="dropdown-item" href="{{url('/commands')}}">Commandes</a>
                            </div>
                        </li>
                        @role('admin')
                        <li><a class="nav-link" href="{{url('/spotify/config')}}">Spotify <i class="fab fa-spotify"></i></a></li>
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li><a class="dropdown-item" href="{{url('/user')}}">{{__('menu.user_settings')}}</a>
                                </li>
                                @hasrole('admin')
                                <li><a class="dropdown-item" href="{{url('/role')}}">{{__('menu.user_roles')}}</a></li>
                                <li><a class="dropdown-item"
                                       href="{{url('/permission')}}">{{__('menu.user_permissions')}}</a></li>
                                <li><a class="dropdown-item" href="{{url('/plugins')}}">{{__('common.plugins')}}</a>
                                </li>
                                @endrole
                                <li>
