<div class="card-container">
    ...
    <div class="card-figures row">
        <div class="col-md-6">
            <span class="figures text-center" data-sensorid="{{$widget->sensor_id}}">{{$sscompteur_history[0]->kwh}}</span>
            <span class="figures-label text-center">kWh</span>
        </div>
        <div class="col-md-6">
            <span class="figures text-center" data-sensorid="{{$widget->sensor_id}}">{{round($sscompteur_history[0]->prix,2)}}</span>
