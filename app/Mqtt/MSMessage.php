...
class MSMessage
{
    ...
    public function setTopicPrefix($tc)
    {
        $this->topic_prefix = $tc;
    }

    public function getTopic()
    {
        $this->topic = 'topic://'.$this->topic_prefix.'/'.$this->node_id.'/'.$this->child_id.'/'.$this->command.'/'.$this->ack.'/'.$this->type;
        return $this->topic;
    }
    // ---------------------------------------------------------
    public function presentation($node_id,$child_id,$sub_type,$ack=0){

        $this->node_id = $node_id;
        $this->child_id = $child_id;
        $this->command = 0;
        $this->type = $this->presentation_types[$sub_type];
        $this->ack = $ack;
    ...
    // ---------------------------------------------------------
    public function set($node_id,$child_id,$sub_type,$ack=0){

        $this->node_id = $node_id;
        $this->child_id = $child_id;
        $this->command = 1;
        $this->type = $this->setreq_types[$sub_type];
        $this->ack = $ack;

        return $this;
    }
    // ---------------------------------------------------------
    public function req($node_id,$child_id,$sub_type,$ack=0){
